The tests for the benchmark below were done using the getting started of the tools involved. No tuning or configuration changes were applied. The goal was to test the out of the box performance of the compared tools.
